    ...
    public partial class Customer_Profile : Form
    {
        ...
        private void dataGridViewcustomer_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                c_halkhataid_textBox.Text = row.Cells["Halkhata_ID"].Value.ToString();
            ...
            private void find_button_Click(object sender, EventArgs e)
        {
            ...
            if (mdr.Read())
            {
                c_contactnumtextBox.Text = mdr.GetInt32("Halkhata_ID").ToString();
        ...
        {
            {
                try
                {
                    ...
                    string Query = "UPDATE halkhatadb.customer set First_Name = '" + this.c_firstnametextBox.Text + "', Last_Name = '" + this.c_lastnametextBox.Text + "', Address = '" + this.c_addresstextBox.Text + "', Phone_Number = '" + this.c_contactnumtextBox.Text + "' where Phone_Number = '" + this.searchTextBox.Text + "';";
